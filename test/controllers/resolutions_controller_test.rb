...
class ResolutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resolution" do
    assert_difference('Resolution.count') do
      post resolutions_url, params: { resolution: { contentR: @resolution.contentR, titleR: @resolution.titleR } }
    end
  ...
  test "should update resolution" do
    patch resolution_url(@resolution), params: { resolution: { contentR: @resolution.contentR, titleR: @resolution.titleR } }
